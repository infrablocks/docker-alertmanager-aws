...
namespace :keys do
  ...
  namespace :gpg do
    RakeGPG.define_generate_key_task(
      ...
      owner_comment: 'docker-alertmanager-aws CI Key'
    )
  end
end
...
RakeCircleCI.define_project_tasks(
  namespace: :circle_ci,
  project_slug: 'github/infrablocks/docker-alertmanager-aws'
) do |t|
  circle_ci_config =
...
RakeGithub.define_repository_tasks(
  namespace: :github,
  repository: 'infrablocks/docker-alertmanager-aws'
) do |t, args|
  github_config =
...
namespace :image do
  RakeDocker.define_image_tasks(
    ...
    t.repository_url = 'infrablocks/alertmanager-aws'
...
namespace :dependencies do
  namespace :test do
    ...
    task :provision do
      project_name = 'docker_alertmanager_aws_test'
